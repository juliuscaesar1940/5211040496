...
<head>
  ...
  <title>Julius Kwofie | Portfolio</title>
  ...
  <main>
    ...
    <section id="lessons" class="container section">
      ...
      <ol>
        ...
        <li><strong>Embedded Systems:</strong> Specialized computers integrated into devices (e.g., traffic lights, microwaves).</li>
      </ol>
